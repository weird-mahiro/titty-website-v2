const config = {
  ...
  // Maybe adding alignment later?
  banner: [
    {
      svgUrl: "/images/titty-coin.svg",
      image: "/images/jayne-mensfield-1.jpg",
    },
    {
      text: "Good Vibe",
      image: "/images/jayne-mensfield-2.jpg",
    },
  ],
  // Adding poster list here
  posters: [
    "/images/poster-1.jpg",
    "/images/poster-2.jpg",
    "/images/poster-3.jpg",
  ...
  footer: {
    shortParagraph: {
      title: "Dad Jokes",
      details:
        "Why did the blockchain bring a ladder? To climb out of rug-pulls! But don’t worry—$TITTY is already soaring. Whether you’re here for memes, moonshots, or a good time, you’ve found the right crew. We're building a movement of transparency, trust, and laughs. Grab a snack, watch your bags grow, and let’s make gains and giggles together! 🚀",
    },
  },
};
